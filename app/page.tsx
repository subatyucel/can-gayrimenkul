...
export default function LandingPage() {
  return (
    <div className="bg-[#0a0a0a] text-gold selection:bg-gold/30 min-h-screen">
      <section className="relative h-screen flex flex-col items-center justify-center px-4 text-center overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-gold/10 via-transparent to-transparent opacity-40" />
        ...
        <div className="relative z-10 space-y-10 animate-in fade-in zoom-in duration-1000">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl md:text-7xl font-serif tracking-tighter text-white uppercase">
              CAN <span className="text-gold">GAYRİMENKUL</span>
            </h1>
            <p className="text-gold text-sm md:text-base tracking-[0.6em] uppercase font-light">
          ...
          <div className="pt-12">
            <Button
              asChild
              size="lg"
              className="bg-gold hover:bg-gold text-black font-bold px-16 py-8 text-xl rounded-none border-none transition-all duration-500 hover:tracking-[0.2em] shadow-[0_0_30px_rgba(197,160,89,0.3)]"
            >
      ...
      <section className="py-32 md:py-48 bg-[#0f0f0f] border-y border-gold/10 relative">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <h3 className="text-gold tracking-[0.4em] uppercase text-xs">
                Kurumsal Profil
              </h3>
              <h2 className="text-4xl md:text-6xl font-serif text-white leading-tight">
                Seçkin Portföy, <br /> Profesyonel{" "}
                <span className="text-gold">Hizmet</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-8 border border-gold/10 bg-black/50 space-y-4">
              ...
              <div className="p-8 border border-gold/10 bg-black/50 space-y-4 sm:col-span-2">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto space-y-12">
            ...
            <footer className="text-[9px] tracking-[0.8em] uppercase opacity-30 text-white">
              ...
              <Link
                href="https://subatyucel.github.io/portfolio"
                target="_blank"
